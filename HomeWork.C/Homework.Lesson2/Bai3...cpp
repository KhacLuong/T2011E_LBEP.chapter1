				...
				if(d<=31){
					...
					if(m==8){
						...
						if((d+31+28+31+30+31+30+31)%7==0){
							...
							printf("\nVa la thu %d",(d+31+28+31+30+31+30+31)%7+1);
						}
					}
					if(m==9){
						if(d<31){
							...
							if((d+31+28+31+30+31+30+31+31)%7==0){
								...
								printf("\nVa la thu %d",(d+31+28+31+30+31+30+31+31)%7+1);
							}	
						}else{
							printf("Nhap sai ngay thang");
						}
					...
					if(m==10){
						...
						if((d+31+28+31+30+31+30+31+31+30)%7==0){
							...
							printf("\nVa la thu %d",(d+31+28+31+30+31+30+31+31+30)%7+1);
						}
					}
					if(m==11){
						if(d<31){
							...
							printf("\nVa la thu %d",(d+31+28+31+30+31+30+31+31+30+31)%7+1);
						}	
						}else{
							printf("Nhap sai ngay thang");
						}
					...
					if(m==12){
						...
						if((d+31+28+31+30+31+30+31+31+30+31+30)%7==0){
							...
							printf("\nVa la thu %d",(d+31+28+31+30+31+30+31+31+30+31+30)%7+1);
						}
					}
				}else{
					printf("Nhap sai ngay thang");
